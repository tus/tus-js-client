...
export default class NodeHttpStack {
  ...
  createRequest(method, url) {
    return new Request(method, url, this.requestOptions);
  }
...
/**
 * A NodeHttpStack which will allow developer to customer `http(s).request()`
 * options, yet force it to accept insecure certificates as well.
 */
export class InsecureNodeHttpStack extends NodeHttpStack {
  constructor(requestOptions = {}) {
...
class Request {
  ...
  send(body = null) {
    return new Promise((resolve, reject) => {
      ...
      options = {...options, ...this._requestOptions};
