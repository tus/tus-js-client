...
export default class StreamSource {
  ...
  async slice (start, end) {
    ...
    while (requestedSize > returnBuffersLength && !this._ended) {
      // TODO: How to handle ended?
      if (this._ended) {
      ...
      console.log("first")
      const newChunk = await readChunk(this._stream, requestedSize - returnBuffersLength)
      //console.log("second")
    ...
    console.log("RETURN", returnBuffer.size, this._ended)
