...
class Upload {
  ...
  setSize(size) {
    // this method should only be used and should only function when
    // upload lenth is defered.
  ...
  _startUpload() {
    ...
    if ((end === Infinity || end > this._size) && this._size != null) {
      end = this._size;
    }
