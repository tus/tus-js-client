...
class BaseUpload {
  ...
  _createUpload() {
    ...
    if (metadata !== '') {
      ...
      const metadataForPartialUploads = encodeMetadata(this.options.metadataForPartialUploads)
      if (metadataForPartialUploads != '') {
        req.setHeader('Upload-Metadata', metadataForPartialUploads)
      }
    }
