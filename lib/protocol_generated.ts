...
export const TUS_OPERATION_RESPONSE_STATUS_CODES: Record<string, readonly number[]> = {
  ...
  createTusUpload: [201, 413, 500],
  getTusUploadOffset: [200],
  patchTusUpload: [204, 500],
  terminateTusUpload: [204, 400, 423],
...
export const TUS_FLOW_POLICY = {
  ...
  eventHooks: {
    ...
    uploadUrlAvailable: {
      contexts: {
        ...
        parallelFinalUpload: 'parallelFinalUpload',
  ...
  fingerprints: {
    ...
    nodeFile: {
      conformanceFixture: {
        absolutePath: '/tmp/tus-contract-file.bin',
...
export function tusPatchUploadRequestPlan({
  ...
  const operationId = TUS_OPERATION_IDS.PATCH_TUS_UPLOAD
