...
export declare const PROTOCOL_IETF_DRAFT_05 = "ietf-draft-05";
/**
...
export type UploadInput = Blob | ArrayBuffer | SharedArrayBuffer | ArrayBufferView | ReadableStream | NodeReadableStream | PathReference | ReactNativeFile;
